  ...
  render() {
    return (
      <div className="ChristianLouboutin">
        ...
        <video className='vidMargin' width="100%" controls loop poster={posterNails}>
          <source src="https://s3.eu-west-2.amazonaws.com/cdedreuille-portfolio/Nails+1.mp4" type="video/mp4" />
        </video>
        <video className='vidMargin' width="100%" controls loop poster={posterFragrance}>
        ...
        <video className='vidMargin' width="100%" controls loop poster={posterGuideline}>
